...
import 'package:a_reader/util/util.dart';
import 'package:a_reader/widgets/input_decoration.dart';
import 'package:a_reader/widgets/two_sided_roundbutton.dart';
...
class _BookDetailsDialogState extends State<BookDetailsDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController _previewTextController =
        TextEditingController(text: widget.book.previewLink);
          ...
          child: Container(
            child: Column(
              children: [
                  ...
                  children: [
                    TwoSidedRoundeButton(
                      ...
                      press: () {
                        ...
                        final userChangedPreviewLink = widget.book.previewLink != _previewTextController.text;

                        final bookUpdate = userChangedTitle ||
                            userChangedAuthor ||
                            userChangedRating ||
                            userChangedPhotoUrl ||
                            userChangedPreviewLink ||
                            userChangedNotes;
                        if (bookUpdate) {
                          _bookCollectionReference
                              ...
                              .update(Book(
                                ...
                                previewLink: _previewTextController.text,
                                rating: _rating == null
                                    ? widget.book.rating
                                    : _rating,
                ...
                TwoSidedRoundeButton(
                press: () => setState(() {
                  _launched = _launchInBrowser(_previewTextController.text);
                }),
                      text: 'Read',
                      radius: 12,
              ),
